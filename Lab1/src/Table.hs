...
errorOnNotExistence, errorOnExistence :: OK
errorOnNotExistence = OK (-100) (-100) 0 0
errorOnExistence = OK (-200) (-200) 0 0

generateWhere, generateSet, generateInsert :: [String] -> String
generateWhere [] = ""
generateWhere [x] = x ++ " = ?"
...
generateInsertValues n = case n of
    0 -> " "
    1 -> "?"
    _ -> "?, " ++ generateInsertValues (n - 1)
